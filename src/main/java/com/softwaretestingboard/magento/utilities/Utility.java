...
//*************************** Action Methods ***************************************//
    ...
    //Click and Clear-click on element and clear
    public void clickAndClear(By by){
        driver.findElement(by).clear();
    }

    //multiple elements store in list of element
    ...
    public List<String> storeProductNamesIntoArrayList(By by) {
    ...
    public List<Double> storeAndSortProductsByPriceInAscendingOrder(By by) {
